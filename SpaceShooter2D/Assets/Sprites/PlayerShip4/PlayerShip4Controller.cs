...
public class PlayerShip4Controller : MonoBehaviour
{
    public GameObject GameManagerObject;
    public GameObject PlayerBullet;
    public GameObject bulletPosition;
    public GameObject Explosion;
    float LazerFiringPeriod = 0.05f;
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        switch (col.tag)
        {
            ...
            case "Level1_Enemy2Bullet":
                PlayExplosion();
                PlayerHealthBar.SetHealthBarValue(PlayerHealthBar.GetHealthBarValue() - 0.13f);
                break;
            ...
            case "Level2BossBullet":
                PlayExplosion();
                PlayerHealthBar.SetHealthBarValue(PlayerHealthBar.GetHealthBarValue() - 0.02f);
                break;
            ...
            case "Level3Enemy2Bullet":
                PlayExplosion();
                PlayerHealthBar.SetHealthBarValue(PlayerHealthBar.GetHealthBarValue() - 0.085f);
                break;
