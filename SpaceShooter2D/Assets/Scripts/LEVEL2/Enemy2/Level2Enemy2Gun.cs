...
public class Level2Enemy2Gun : MonoBehaviour
{
    public GameObject enemy_bullet;  //enemy's gun bullet in prefab
    ...
    void FireEnemyBullet()
    {
        ...
        if (PlayerShip != null || PlayerShip2 != null || PlayerShip3 != null || PlayerShip4 != null)  //if player not dead
        {
            ...
            bullet.GetComponent<Level2Enemy2Bullet>().SetDirection(direction);
        }
